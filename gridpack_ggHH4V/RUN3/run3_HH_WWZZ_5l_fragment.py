...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
                                     args = cms.vstring('/home/llr/cms/agaile/production/run3/gridpack/ggHH_slc7_amd64_gcc10_CMSSW_12_4_13_patch1_aworkdir2.tgz'),
...
generator = cms.EDFilter(
    "Pythia8ConcurrentHadronizerFilter",
        ...
        processParameters = cms.vstring(
            ...
            '23:onIfAny = 11 13 15', # find out if also 6 7 8 and 15
            ...
            'ResonanceDecayFilter:daughters = 24,24,23,23,11,11,11,11,11',
          ),
